...
public class GetPublicationsByLocationQueryHandler {

    private final PublicationRepository publicationRepository;
    private final PublicationMapper publicationMapper;

    public GetPublicationsByLocationQueryHandler(PublicationRepository publicationRepository,
                                                 PublicationMapper publicationMapper) {
        this.publicationRepository = publicationRepository;
        this.publicationMapper = publicationMapper;
    }

    public List<PublicationResponse> handle(GetPublicationsByLocationQuery query) {
        List<Publication> publications = publicationRepository.findByLocation(
                query.getCity(),
                query.getState()
        );
