...
public class CreatePublicationCommand {
    ...
    public CreatePublicationCommand(Long userId, String title, String description,
                                    Long categoryId, BigDecimal price, String currency,
                                    String condition, Integer availableQuantity,
